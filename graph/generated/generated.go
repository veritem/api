...
type QueryResolver interface {
	Name(ctx context.Context) (*model.Name, error)
}
...
func (ec *executionContext) _Query_name(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNName2ᚖgithubᚗcomᚋveritemᚋapiᚋgraphᚋmodelᚐName(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNName2githubᚗcomᚋveritemᚋapiᚋgraphᚋmodelᚐName(ctx context.Context, sel ast.SelectionSet, v model.Name) graphql.Marshaler {
	return ec._Name(ctx, sel, &v)
}

func (ec *executionContext) marshalNName2ᚖgithubᚗcomᚋveritemᚋapiᚋgraphᚋmodelᚐName(ctx context.Context, sel ast.SelectionSet, v *model.Name) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
